...
#include <stdlib.h> //biblioteca de alocação de espaço de mémoria
...
int registro() //Função responsável por cadastrar os usuários no sistema
{
	...
	scanf("%s",cpf);//%s referi-se a string
...
int consulta()
{
	setlocale(LC_ALL, "Portuguese"); // Definindo Linguaem
...
int main()
		...
		for(laco=1;laco=1;)
	{
		...
		printf("Escolha a opão de menu desejada\n\n");
